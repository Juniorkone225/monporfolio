...
(function (e, t) {
    function i(t, i) {
        ...
        return "area" === r
            ? ((a = t.parentNode), (n = a.name), t.href && n && "map" === a.nodeName.toLowerCase() ? ((o = e("img[usemap=#" + n + "]")[0]), !!o && s(o)) : !1)
            : (/input|select|textarea|button|object/.test(r) ? !t.disabled : "a" === r ? t.href || i : i) && s(t);
    }
    function s(t) {
        return (
    ...
    (e.cleanData = function (t) {
        ...
        (e.widget = function (i, s, a) {
            ...
            (i = i.split(".")[1]),
                ...
                e.extend(o, r, { version: a.version, _proto: e.extend({}, a), _childConstructors: [] }),
                (h = new s()),
                ...
                (o.prototype = e.widget.extend(h, { widgetEventPrefix: r ? h.widgetEventPrefix || i : i }, l, { constructor: o, namespace: u, widgetName: i, widgetFullName: n })),
                r
                        ...
                        ? this.each(function () {
                              ...
                              return a
                                  ? e.isFunction(a[r]) && "_" !== r.charAt(0)
                                      ? ((s = a[r].apply(a, h)), s !== a && s !== t ? ((l = s && s.jquery ? l.pushStack(s.get()) : s), !1) : t)
            ...
            (this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist")),
                ...
                this.anchors.each(function (i, a) {
                    ...
                    s(a)
                        ...
                        : ((o = t._tabId(l)), (n = "#" + o), (r = t.element.find(n)), r.length || ((r = t._createPanel(o)), r.insertAfter(t.panels[i - 1] || t.tablist)), r.attr("aria-live", "polite")),
            ...
            (p.style.cssText = "background-color:rgba(1,1,1,.5)"),
                ...
                (u.hsla.to = function (e) {
                    ...
                    var t,
                        ...
                        d = 0.5 * u;
                    return (
                        (t = h === o ? 0 : s === o ? (60 * (a - n)) / l + 360 : a === o ? (60 * (n - s)) / l + 120 : (60 * (s - a)) / l + 240),
                        ...
                        m(n, function (t, i) {
                            l.fn[t] ||
                                (l.fn[t] = function (a) {
                                    ...
                                    return "undefined" === r
                                        ? u
                                        : ("function" === r && ((a = a.call(this, u)), (r = e.type(a))),
                                          null == a && i.empty ? this : ("string" === r && ((n = o.exec(a)), n && (a = u + parseFloat(n[2]) * ("+" === n[1] ? 1 : -1))), (l[i.idx] = a), this[h](l)));
                                });
                        });
                }),
                (l.hook = function (t) {
...
(function (e) {
    ...
    e.effects.effect.blind = function (s, a) {
        ...
        h.parent().is(".ui-effects-wrapper") ? e.effects.save(h.parent(), l) : e.effects.save(h, l),
            h.show(),
            (n = e.effects.createWrapper(h).css({ overflow: "hidden" })),
            (r = n[p]()),
...
(function (e) {
    e.effects.effect.bounce = function (t, i) {
        ...
        for (
            ...
            (a = {}), (a[v] = (y ? "-=" : "+=") + c), r.animate(a, f, g).animate(n, f, g), (c = l ? 2 * c : c / 2);
        l && ((a = { opacity: 0 }), (a[v] = (y ? "-=" : "+=") + c), r.animate(a, f, g)),
            r.queue(function () {
            ...
            for (h = g.top + n * y, u = n - (d - 1) / 2, r = 0; c > r; r++)
                (o = g.left + r * v),
                    ...
                    p
                        ...
                        .appendTo("body")
                        .wrap("<div></div>")
                        .css({ position: "absolute", visibility: "visible", left: -r * v, top: -n * y })
                        .parent()
                        .addClass("ui-effects-explode")
                        .css({ position: "absolute", overflow: "hidden", width: v, height: y, left: o + (f ? l * v : 0), top: h + (f ? u * y : 0), opacity: f ? 0 : 1 })
                        .animate({ left: o + (f ? 0 : l * v), top: h + (f ? 0 : u * y), opacity: f ? 1 : 0 }, t.duration || 500, t.easing, s);
    };
})(jQuery);
(function (e) {
...
(function (e) {
    (e.effects.effect.puff = function (t, i) {
        ...
        e.extend(t, { effect: "scale", queue: !1, fade: !0, mode: a, complete: i, percent: n ? r : 100, from: n ? h : { height: h.height * o, width: h.width * o, outerHeight: h.outerHeight * o, outerWidth: h.outerWidth * o } }),
            s.effect(t);
    }),
        ...
        (e.effects.effect.size = function (t, i) {
            ...
            "show" === p && r.show(),
                (s = { height: r.height(), width: r.width(), outerHeight: r.outerHeight(), outerWidth: r.outerWidth() }),
                "toggle" === t.mode && "show" === p ? ((r.from = t.to || b), (r.to = t.from || s)) : ((r.from = t.from || ("show" === p ? b : s)), (r.to = t.to || ("hide" === p ? b : s))),
                (n = { from: { y: r.from.height / s.height, x: r.from.width / s.width }, to: { y: r.to.height / s.height, x: r.to.width / s.width } }),
                ("box" === f || "both" === f) &&
                    (n.from.y !== n.to.y && ((y = y.concat(d)), (r.from = e.effects.setTransition(r, d, n.from.y, r.from)), (r.to = e.effects.setTransition(r, d, n.to.y, r.to))),
                    n.from.x !== n.to.x && ((y = y.concat(c)), (r.from = e.effects.setTransition(r, c, n.from.x, r.from)), (r.to = e.effects.setTransition(r, c, n.to.x, r.to)))),
                ("content" === f || "both" === f) && n.from.y !== n.to.y && ((y = y.concat(u).concat(l)), (r.from = e.effects.setTransition(r, u, n.from.y, r.from)), (r.to = e.effects.setTransition(r, u, n.to.y, r.to))),
                e.effects.save(r, y),
                r.show(),
                e.effects.createWrapper(r),
...
(function (e) {
    e.effects.effect.shake = function (t, i) {
        var s,
            ...
            v = a.queue(),
            y = v.length;
        for (e.effects.save(a, n), a.show(), e.effects.createWrapper(a), m[c] = (p ? "-=" : "+=") + h, f[c] = (p ? "+=" : "-=") + 2 * h, g[c] = (p ? "-=" : "+=") + 2 * h, a.animate(m, d, t.easing), s = 1; l > s; s++)
    ...
    e.effects.effect.transfer = function (t, i) {
        var s = e(this),
            ...
            c = e("<div class='ui-effects-transfer'></div>")
                ...
                .css({ top: d.top - o, left: d.left - h, height: s.innerHeight(), width: s.innerWidth(), position: n ? "fixed" : "absolute" })
